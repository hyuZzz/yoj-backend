package com.yuhi.yojbackenduserservice.controller;
...
import com.yuhi.yojbackendmodel.model.dto.user.*;
...
import com.yuhi.yojbackendmodel.model.vo.UserCodeVO;
...
import static com.yuhi.yojbackendcommon.constant.UserConstant.SALT;
...
//        System.out.println("user:123  "+user);
    ...
    public BaseResponse<Boolean> resUser(@RequestBody UserUpdateRequest userUpdateRequest,
                                            HttpServletRequest request) {
        if (userUpdateRequest == null || userUpdateRequest.getId() == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
